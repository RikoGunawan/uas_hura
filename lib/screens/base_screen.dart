...
//           ClipRRect(
//             borderRadius: BorderRadius.circular(0), // No rounding to fill the screen
//             child: Image.asset(
//               'assets/tahura.jpg',
...
// Widget _buildButtonLogin({required String text, required VoidCallback onPressed}) {
//   return SizedBox(
...
//         ),
//         minimumSize: const Size(double.infinity, 48), // Full height for buttons
//       ),
//       child: Text(
//         text,
...
// Widget _buildButtonNew({required String text, required VoidCallback onPressed}) {
//   return SizedBox(
//     width: 400, // Set a fixed width for the button
